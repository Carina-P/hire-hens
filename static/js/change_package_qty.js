...
function handleEnableDisable(itemId) {
    let currentValue = parseInt($(`#id-package_qty_${itemId}`).val());
    let minusDisabled = currentValue < 2;
    let plusDisabled = currentValue > 39;
    $(`#decrement-package-qty_${itemId}`).prop('disabled', minusDisabled);
    $(`#increment-package-qty_${itemId}`).prop('disabled', plusDisabled);
}
